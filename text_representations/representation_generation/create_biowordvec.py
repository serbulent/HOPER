...
def create_reps(tp):
    ...
    df.to_csv('/media/DATA/home/muammer/HOPER/Reproduction/text_representations/representation_generation/biowordvec_representations/' + tp + '_biowordvec_vectors_multi_col.csv', index = False)
