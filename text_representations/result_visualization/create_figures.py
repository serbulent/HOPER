...
def prepare_figure_data_for_aspect(aspect):
    ...
    pred_mean_df_table.to_csv("/media/DATA/home/muammer/HOPER/Reproduction/text_representations/result_visualization/tables/" + aspect + "_pred_mean_table.csv")
...
def create_figures():
    ...
    pred_mean_df_MF.T.to_csv("/media/DATA/home/muammer/HOPER/Reproduction/text_representations/result_visualization/figures/pred_mean_df_MF.csv")
    pred_mean_df_BP.T.to_csv("/media/DATA/home/muammer/HOPER/Reproduction/text_representations/result_visualization/figures/pred_mean_df_BP.csv")
    pred_mean_df_CC.T.to_csv("/media/DATA/home/muammer/HOPER/Reproduction/text_representations/result_visualization/figures/pred_mean_df_CC.csv")
    ...
    g.savefig('/media/DATA/home/muammer/HOPER/Reproduction/text_representations/result_visualization/figures/func_pred_MF.png')
    ...
    ax.set_ylabel("")
    set_colors_and_marks_for_representation_groups(ax)
    g.savefig('/media/DATA/home/muammer/HOPER/Reproduction/text_representations/result_visualization/figures/func_pred_BP.png')
    ...
    ax.set_ylabel("")
    set_colors_and_marks_for_representation_groups(ax)
    g.savefig('/media/DATA/home/muammer/HOPER/Reproduction/text_representations/result_visualization/figures/func_pred_CC.png')
