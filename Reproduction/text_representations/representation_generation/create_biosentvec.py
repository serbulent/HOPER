...
def create_reps(tp):
    ...
    df.to_csv('/media/DATA/home/muammer/HOPER/Reproduction/text_representations/representation_generation/biosentvec_representations/' + tp + '_biosentvec_vectors_multi_col.csv', index = False)
