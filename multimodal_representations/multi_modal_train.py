...
("/media/DATA2/sinem/isik_makale_1003/\
multi_modal_rep_ae_"+str(representation_dim)+"_dim_"+str(epochs)+"_epochs_ppi_no_comp.csv"\
,index=False)

torch.save(best_model.state_dict(), "/media/DATA2/sinem/isik_makale_1003/multimodel_weights.pth")
